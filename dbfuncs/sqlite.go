...
func Ceil[I c.Integer, F c.Float](val qb.Expr[F]) qb.Expr[I] {
...
func Round[I c.Integer, F c.Float](val qb.Expr[F]) qb.Expr[I] {
...
func Sign[I c.Integer, F c.Float](val qb.Expr[F]) qb.Expr[I] {
	return qb.F[F, I]("sign", val)
}

// Sqrt function returns the square root of a number.
func Sqrt[F c.Float, N c.Number](val qb.Expr[N]) qb.Expr[F] {
	return qb.F[N, F]("sqrt", val)
}

// Trunc function returns a truncated number.
func Trunk[I c.Integer, F c.Float](val qb.Expr[F]) qb.Expr[I] {
